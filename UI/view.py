...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnRaggiungibili = ft.ElevatedButton(text="Raggiungibili",on_click=self._controller.handleRaggiungibili,disabled=True)
        row2 = ft.Row([self._ddStati,self._btnRaggiungibili], alignment=ft.MainAxisAlignment.CENTER)
